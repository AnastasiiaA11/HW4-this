...
int AAHH = HomeworkCycles.FindaNumberUsingTheHalfDivisionMethod(enteredNumber);
...
//Console.WriteLine("Введите число");
//int N = Convert.ToInt32(Console.ReadLine());
//int[] Aoo = HomeworkCycles.OutputNumbersInTheRange(N);
//Console.Write(Aoo);
...
//bool EA = HomeworkCycles.TellMeIfThereAreTheSameDigitsInTheSpellingOfTwoNumbers(NumberEnteredA, NumberEnteredB);
